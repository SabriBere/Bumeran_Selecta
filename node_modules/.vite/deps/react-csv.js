import {
  require_prop_types
} from "./chunk-YZTN3DQR.js";
import "./chunk-6JXCARDC.js";
import {
  require_react
} from "./chunk-PLNKHFBH.js";
import {
  __publicField,
  __toESM
...
var isJsons = (array2) => Array.isArray(array2) && array2.every((row) => typeof row === "object" && !(row instanceof Array));
var isArrays = (array2) => Array.isArray(array2) && array2.every((row) => Array.isArray(row));
var jsonsHeaders = (array2) => Array.from(array2.map((json) => Object.keys(json)).reduce((a, b) => /* @__PURE__ */ new Set([...a, ...b]), []));
...
__publicField(CSVDownload, "defaultProps", Object.assign(defaultProps, defaultProps2));
...
var CSVLink = class extends import_react3.default.Component {
  ...
  render() {
    ...
    return import_react3.default.createElement("a", {
      download: filename,
      ...rest,
